...
function safeReport(){return {version:'0.1.0-alpha.49',generated_at:new Date().toISOString(),guild:'redacted',page:state.page,diagnostics:last,client:{user_agent:navigator.userAgent,online:navigator.onLine,errors:clientDiagnostics.errors.slice(-50),network_failures:clientDiagnostics.networkFailures.slice(-50),request_log:clientDiagnostics.requests.slice(-100)},privacy:'Verbose logs are sanitized. Tokens, secrets, cookies, authorization headers, credentials and message contents are excluded.'}}
